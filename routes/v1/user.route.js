...
const {tokenVerify, authRole, authRefreshToken} = require('../../middlewares/auth')



router.post('/users', validate(userValidation.createUser), userController.addUser)
router.get('/users', tokenVerify, authRole('admin'), authRefreshToken, userController.getAllUsers)
